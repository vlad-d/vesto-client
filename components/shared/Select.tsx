...
export default function Select({name, options = {}, label, selectOptions, placeholder, selectedValue}: IInput) {
  const {
    setValue,
    formState: {errors},
    register
  ...
  return (
      <div className="relative">
        ...
        <SelectElement options={_selectOptions} onChange={onSelectChange} selectedValue={selectedValue}/>
        {!!errors[name] && (
