...
export default function SelectElement({ options, onChange, selectedValue }: ISelectElementProps) {
  const [selected, setSelected] = useState<IOption>(selectedValue ?? options[0]);
